...
try:
    ...
    clumpyFile = "template/clumpy_fnu_norm.hdf5"
    ...
    ip = None
waveLim = [1e-2, 1e3]
def CLUMPY_intp(logL, i, tv, q, N0, sigma, Y, wave, DL, z, logtau_CLUMPY, frame="rest", t=ip, waveLim=waveLim):
    """
    ...
    flux = flux * Extinction(logtau_CLUMPY, wave[fltr])
    return flux
#Func_end
