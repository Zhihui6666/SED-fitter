...
from model_analyticals import Extinction
...
def DL07(logumin, logumax, qpah, loggamma, logMd, DL, z, wave,logtau_DL07, frame="rest", t=tdl07, waveLim=waveLim):
    """
    ...
    flux = flux * Extinction(logtau_DL07, wave)
    return flux
...
'''
def DL07_old(logumin, logumax, qpah, gamma, logMd, DL, z, wave, frame="rest", t=tdl07, waveLim=waveLim):
    """
    This function generates the dust emission template from Draine & Li (2007).
...
def DL07_PosPar_old(logumin, logumax, qpah, gamma, logMd, t=tdl07):
    """
    To position the parameters in the parameter grid. If true, the function
    will return the paramteter grid found nearest from the input parameters
    using the KDTree template.
