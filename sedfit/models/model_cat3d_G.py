...
def Cat3d_G(a, theta, N0, i, logL, DL, z, logtau_torus, wave, frame="rest", t=tcat3d_G, waveLim=waveLim):
    """
    ...
    flux[fltr] = Extinction(logtau_torus, wave[fltr]) * f0 * t(wave[fltr], para) * 1e29  # unit: mJy
    return flux
